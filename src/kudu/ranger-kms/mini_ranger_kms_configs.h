...
inline std::string GetRangerKMSSecurityXml(const std::string& ranger_url, const std::string& kms_home) {
...
inline std::string GetRangerKMSAuditXml() {
  const char *kRangerKMSAuditXml = R"(
<configuration>
  <property>
...
inline std::string GetRangerKMSPolicymgrSSLXml() {
  const char *kRangerKMSPolicymgrSSLXml = R"(
